...
class TrellisTextTo4DPipeline(Pipeline):
    """
    ...
    @staticmethod
    def from_pretrained(path: str) -> "TrellisTextTo4DPipeline":
        """
        ...
        """
        pipeline = super(TrellisTextTo4DPipeline, TrellisTextTo4DPipeline).from_pretrained(path)
        new_pipeline = TrellisTextTo4DPipeline()
    ...
    def sample_slat(
        ...
        noise_shape = (coords.shape[0], flow_model.in_channels)
