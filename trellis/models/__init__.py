...
__attributes = {
    ...
    # 'TemporalSparseStructureFlowModel': 'sparse_structure_flow',
...
if __name__ == '__main__':
    ...
    from .sparse_structure_flow import (
        ...
        # TemporalSparseStructureFlowModel,
    )

    from .sparse_structure_flow_4d import (
        SparseStructureFlow4DModel,
    )
    ...
    from .structured_latent_flow_4d import (
        SLatFlow4DModel,
    )